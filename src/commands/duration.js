...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addIntegerOption((option) => option.setName('minutes').setDescription('Enter Minutes').setRequired(true))
    .addIntegerOption((option) => option.setName('hours').setDescription('Enter hours')),

  async execute(interaction) {
    const newDuration = dayjs().add(
      dayjs.duration({
