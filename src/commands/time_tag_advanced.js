  ...
  async execute(interaction) {
    ...
    const daystr = dayjs(
      ...
      row1 = new MessageActionRow()
        .addComponents(
          new MessageButton().setCustomId('formatone').setLabel('Format 1').setStyle('PRIMARY'),
        )
        .addComponents(
          new MessageButton().setCustomId('formattwo').setLabel('Format 2').setStyle('PRIMARY'),
        )
        .addComponents(
          new MessageButton().setCustomId('formatthree').setLabel('Format 3').setStyle('PRIMARY'),
        )
        .addComponents(
          new MessageButton().setCustomId('formatfour').setLabel('Format 4').setStyle('PRIMARY'),
        ),
      // eslint-disable-next-line sort-vars
      row2 = new MessageActionRow()
        .addComponents(
          new MessageButton().setCustomId('formatfive').setLabel('Format 5').setStyle('PRIMARY'),
        )
        .addComponents(
          new MessageButton().setCustomId('formatsix').setLabel('Format 6').setStyle('PRIMARY'),
        )
        .addComponents(
          new MessageButton().setCustomId('formatseven').setLabel('Format 7').setStyle('PRIMARY'),
        )
        .addComponents(
          new MessageButton().setCustomId('formateight').setLabel('Format 8').setStyle('PRIMARY'),
        ),
        ...
        const errEmb = new MessageEmbed()
          ...
          .addFields([
            ...
            },
            {
              ...
              value: "Processed timezone is not matching with input provided, Date doesn't exist.",
            },
          ]);
